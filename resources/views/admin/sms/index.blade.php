		...
		<section class="director-benachrichtigung director-main">
			...
			<div class="director-content">
									...
									<div class="info">
										<p>
											<input type="checkbox"
											       ...
											       id="confirm_btn"
										           v-model="sepaRules">
											<label for="confirm_btn">
												@lang('sms.buy_confirm_information')
											</label>
				...
				<div class="tab_content" :class="{'is-active':  toggleMenuSms === '#5'}">
					<form id="smsMessageForm" @submit.prevent="saveSMSContent" class="custom_message">
							...
							<div class="message_form">
								<div class="left">
									...
									<div class="originator">
										...
										<input name="title" type="text" id="titleSMS" v-model="data.sms_data.title">
									</div>
						...
						<div class="save_mess">
							<button type="submit">@lang('sms.message_save')</button>
						</div>
					</form>
				</div>
			</div>
