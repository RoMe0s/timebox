<template id="employee-info-new-template">
    ...
    <div class="assistant-form__row __margin col--6" v-show="userInfo.is_admin_employee !== true || userInfo.is_admin_employee === undefined">
        <div class="assistant-form__col assistant-form__col--12">
            <label class="assistant-form__label">
                {!! trans('common.group') !!}
            </label>
            <select name="group" class="assistant-input assistant-input--select" required>
                <option value="admin" v-bind:selected="userInfo.employee.group === 'admin'">
                    {!! trans('common.admin') !!}
                </option>
                <option value="employee" v-bind:selected="userInfo.employee.group === 'employee'">
                    {!! trans('common.employee') !!}
                </option>
            </select>
        </div>
    </div>
    <div class="assistant-form__row __margin col--6" style="position: absolute; height: 300px; left: calc(50% + 10px); margin: -4px 0 0 0; width: calc(50% - 40px);">
        <div class="assistant-form__col assistant-form__col--12">
            <label class="assistant-form__label">
    ...
    <div class="assistant-form__row __margin margin-10">
        <div class="assistant-form__col assistant-form__col--6">
            <input type="checkbox" class="assistant-form__checkbox assistant-input--checkbox" name="status" value="active" id="be-employee-checkbox" v-bind:checked="userInfo.employee.status === 'active'">
