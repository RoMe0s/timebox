<template id="employee-info-new-template">
    ...
    <div class="assistant-form__row">
        <div class="assistant-form__col assistant-form__col---6">
            ...
            <input class="assistant-input" type="text" name="firstname" required v-bind:value="userInfo.employee.name || userInfo.employee.firstname">
        </div>
        <div class="assistant-form__col assistant-form__col---6">
            <label class="assistant-form__label">
                {!! trans('common.last_name') !!}
            </label>
            <input class="assistant-input" type="text" name="lastname" required v-bind:value="userInfo.employee.last_name || userInfo.employee.lastname">
        </div>
    </div>
    ...
    <div class="assistant-form__row">
        <div class="assistant-form__col assistant-form__col---6">
            ...
            <input class="assistant-input" type="tel" name="mobile" v-bind:value="userInfo.employee.phone || userInfo.employee.mobile" required maxlength="15" minlength="5">
        </div>
        <div class="assistant-form__col assistant-form__col---6">
            <label class="assistant-form__label">
                {!! trans('common.email') !!}
    ...
    <div class="assistant-form__row __margin col--6" style="position: absolute; height: 200px; left: calc(50% + 10px); margin: -4px 0 0 0; width: calc(50% - 40px);">
        <div class="assistant-form__col assistant-form__col--12">
            ...
            <ul v-show="categories !== undefined && categories.length" id="assistant-create-employee-services" style="height: 200px !important;">
    ...
    <div class="assistant-form__row __margin margin-10">
        <input type="hidden" name="mainAdmin" value="">
        <div class="assistant-form__col assistant-form__col--6">
            <input type="checkbox" class="assistant-form__checkbox assistant-input--checkbox" name="is_employee" value="active" id="be-employee-checkbox" v-bind:checked="userInfo.mainAdmin === false">
