...
@section('content')
    <section class="director-benachrichtigung director-main">
        ...
        <h1 class="director-content__heading heading heading__h1">
            {!! trans('common.code editing') !!}
        </h1>

        <div class="director-content">

            <code-edit-vue id="{!! $id !!}" module="{{$module}}"></code-edit-vue>
    ...
    <template id="code-edit-template">
        ...
        <div class="assistant-block assistant" style="padding-top: 20px">
            ...
            <form enctype="multipart/form-data" v-on:submit.prevent="trySendForm($event)" method="PUT" action="/backend/code/{{$id}}/update">
