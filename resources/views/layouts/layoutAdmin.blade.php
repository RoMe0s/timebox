...
<script src="{{ asset('scripts/highlight.js') }}"></script>
<script src="{{ asset('scripts/colorpicker.js') }}"></script>
<script src="{{ asset('scripts/libs/moment.min.js') }}"></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.1.0/fullcalendar.min.js"></script>
<script src="{{ asset('scripts/libs/jquery.validate.min.js') }}"></script>
<script src="{{ asset('scripts/locale-all.js') }}"></script>
<script src="{{ asset('scripts/palette-color-picker.min.js') }}"></script>
