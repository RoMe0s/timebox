    ...
    <div class="assistant">
        ...
        <section v-show="step === 0" class="assistant-hero" style="margin-top: calc(25% - 140px)">
            <div class="assistant-hero_2_in" style="width: 100%">
                ...
                <button
                        @click="nextStep"
                        class="assistant-btn assistant-btn--red">{{ $t("step0.btn") }}
                </button>
            </div>
        </section>
            ...
            <div class="assistant-step__in">
                        ...
                        <form id="assistantForm1" class="assistant-form">
                            ...
                            <div class="assistant-form__row">
                                ...
                                <div class="assistant-form__col assistant-form__col--6">
                                    ...
                                    <input v-model="assistantData.firstname" :value="startData.admin_data.firstname"
                                           type="text" name="firstname" class="assistant-input" id="first-name"
                                           required>
                                </div>
                                ...
                                <div class="assistant-form__col assistant-form__col--6">
                                    ...
                                    <input v-model="assistantData.lastname" :value="startData.admin_data.lastname"
                                           type="text" name="lastname" class="assistant-input" id="last-name" required>
                                </div>
                            ...
                            <div class="assistant-form__row">
                                ...
                                <div class="assistant-form__col assistant-form__col--6">
                                    ...
                                    <input v-model="assistantData.email" :value="startData.admin_data.email"
                                           type="email" class="assistant-input" id="email" required name="email">
                                </div>

                                <div class="assistant-form__col assistant-form__col--6">
                                    <label for="website" class="assistant-form__label">Website</label>
                                    <input v-model="assistantData.firmname" type="text" class="assistant-input"
                                           id="website" required name="firmname">
                                </div>
                            ...
                            <div class="assistant-form__row">
                                ...
                                <div class="assistant-form__col assistant-form__col--6">
                                    ...
                                    <input v-model="assistantData.telnumber" :value="startData.admin_data.telnumber"
                                           type="tel" class="assistant-input" id="phone" required name="telnumber">
                                </div>

                                <div class="assistant-form__col assistant-form__col--6">
                                    <label for="mobile" class="assistant-form__label">{{ $t("step1.mobile") }}</label>
                                    <input v-model="assistantData.mobile" :value="startData.admin_data.mobile"
                                           type="tel" class="assistant-input" id="mobile" name="mobile">
                                </div>
                ...
                <form
                    ...
                    <button @click.stop.prevent="changeAvatar"
                            class="assistant-upload__btn assistant-btn assistant-btn--red">{{ $t("step1.uploadAvatar")
                        }}
                    </button>
                </form>
            ...
            <div class="assistant-step__in">
                        ...
                        <form id="assistantForm2" class="assistant-form">
                            ...
                            <div class="assistant-form__row">
                                <div class="assistant-form__col assistant-form__col--12">
                                    ...
                                    <input v-model="assistantData.firm_name" type="text" name="firm_name"
                                           class="assistant-input" id="name-company">
                                </div>
                            </div>
                            ...
                            <div class="assistant-form__row">
                                ...
                                <div class="assistant-form__col assistant-form__col--4">
                                    ...
                                    <select
                                            ...
                                            name="country" id="country" class="assistant-input assistant-input--select"
                                ...
                                <div class="assistant-form__col assistant-form__col--4">
                                    ...
                                    <select
                                            ...
                                            v-model="assistantData.state" name="state" id="state"
                                            class="assistant-input assistant-input--select"
                                ...
                                <div class="assistant-form__col assistant-form__col--4">
                                    ...
                                    <select v-model="assistantData.city" class="assistant-input assistant-input--select"
                                            name="city" id="city" placeholder="Select city...">
                            ...
                            <div class="assistant-form__row">
                                ...
                                <div class="assistant-form__col assistant-form__col--6">
                                    ...
                                    <input v-model="assistantData.post_index" type="text" class="assistant-input"
                                           id="index" name="post_index" required>
                                </div>

                                <div class="assistant-form__col assistant-form__col--6">
                                    <label for="street" class="assistant-form__label">{{ $t("all.address") }}</label>
                                    <input v-model="assistantData.street" type="text" class="assistant-input"
                            ...
                            <div class="assistant-form__row">
                                ...
                                <div class="assistant-form__col assistant-form__col--6">
                                    ...
                                    <select v-model="assistantData.firmtype" name="firmtype" id="business"
                                            class="assistant-input assistant-input--select"
                                            placeholder="Wähle Deine Branche aus…">
                                        ...
                                        <option
                                                ...
                                                :value="firmtype.id">{{ firmtype.firmtype }}
                                        </option>
                                    </select>
                                </div>
                ...
                <div class="assistant-block assistant-upload" id="assistantUploadLogo">
                    ...
                    <div @dragover.prevent @drop="onFileChange($event, 'logo')" class="assistant-upload__drop">
                        <input class="assistant-block__file" id="assistantLogo" type="file"
                               @change="onFileChange($event, 'logo')">
                        <img class="assistant-upload__image" :src="imgs.logo"/>
                    </div>

                    <button @click.stop.prevent="changeLogo"
                            class="assistant-upload__btn assistant-btn assistant-btn--red">{{ $t("step2.uploadLogo") }}
                    </button>
                </div>
