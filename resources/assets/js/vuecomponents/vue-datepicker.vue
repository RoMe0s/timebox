...
exports.default = {
  ...
  ready(){
    ...
    this.$http.post('/translate', data).then((response)=>{
      ...
      this.library.week = [this.translatedText.dayMo, this.translatedText.dayTu, this.translatedText.dayWe, this.translatedText.dayTh, this.translatedText.dayFr, this.translatedText.daySa, this.translatedText.daySu];

      this.library.month = [this.translatedText.monthJa,this.translatedText.monthFe ,this.translatedText.monthMa ,this.translatedText.monthAp ,this.translatedText.monthMay ,this.translatedText.monthJu,this.translatedText.monthJul ,this.translatedText.monthAu,this.translatedText.monthSep ,this.translatedText.monthOct ,this.translatedText.monthNow ,this.translatedText.monthDec];

        this.option.placeholder = this.translatedText.whenTr;
        this.option.buttons = {
            ok: this.translatedText.ok_btn,
            cancel: this.translatedText.cnl_btn
          },
      console.log(this.library.week);
  },(response)=>{
