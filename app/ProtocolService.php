...
class ProtocolService extends Model
{
	 ...
	 * @return bool
	 */
	public static function protocolAdminServiceCreate($admin_id = null, $service_id, $request, $author = 'admin')
	{
		if ($admin_id) {
			self::create([
				'admin_id'   => $admin_id,
	 ...
	 * @return bool
	 */
	public static function protocolAdminCategoryDelete($admin_id = null, $service_id, $request, $author = 'admin')
	{
		if ($admin_id) {
