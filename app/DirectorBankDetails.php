 ...
 * @property string $creditor_id_number
 ...
 * @method static \Illuminate\Database\Query\Builder|\App\DirectorBankDetails whereCreditorIdNumber($value)
 ...
 * @method static \Illuminate\Database\Query\Builder|\App\DirectorBankDetails whereTariff($value)
 * @method static \Illuminate\Database\Query\Builder|\App\DirectorBankDetails whereTariffPerEmployee($value)
...
class DirectorBankDetails extends Model
{
    ...
    protected $fillable = ['account_owner', 'account_number', 'bank_code', 'bank_name', 
                        'iban', 'bic', 'ust_id', 'trade_register', 'tax_number', 'creditor_id_number','firm_name', 'first_last_name',
                        'post_index', 'street', 'addition_address', 'logo', 'tariff', 'tariff_per_employee'];
